...
'''
import numpy
from pyscf.neo.hf import HF #from pyscf.neo.ks import KS
...
def position_analysis(mf, fock, s1e, int1e_r):
    ...
    print('timer[2]: timing of the position analysis function', finish_timer_2 - start_timer_2)
    return numpy.einsum('xij,ji->x', int1e_r, dm) 

class CDFT(HF): #class CDFT(KS):
    '''
    Examples::
    ...
    def __init__(self, mol, **kwargs):
        ...
        for i in range(len(self.mol.nuc)):
            ...
            print('expectation position: ', mf.nuclei_expect_position)
