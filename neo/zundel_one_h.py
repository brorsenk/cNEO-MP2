...
import inspect
print(sys.version)
#sys.stdout = open(inpstdoutfile, 'wt')
...
#
        ...
        #---------------------------------------------------------------------------------------------
            ...
            check_RMSD_n = 0# RMSD_n(self, t_old_n, t_new_n)
        #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            ...
            diff_E_n = 0 #hyll_n - old_hyll_n
            diff_E_e = hyll_e - old_hyll_e
            diff_E_en = hyll_en - old_hyll_en

            print(asterisk)

            print('ITERATION: ', t, '-------', 'E(MP2)_e: ', hyll_e, 'E(MP2)_en: ', hyll_en, 'E(MP2)_n: ', old_hyll_n)#hyll_n)
            print(line)
        ...
        #compare = one_dim_density_off_axis(self, number_of_points)
        #for i in range(len(self.con.mol.nuc)):
        ...
        #-------------------------------------------------------------------------------
        #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        return self.base_energy, old_hyll_n, hyll_e, hyll_en, self.lagr
...
#---------------------------------------------------------------------------------------------------------------
    ...
    noatoms = 3 
    dimensions = 3
    coordinate_array = numpy.loadtxt('zundel-coords.xyz')

    coordinates_inp = coordinate_array.flatten()
    ...
    def energy(coordinates):
        ...
        mol.build(atom=[['H',coordinates[0:dimensions]],
                        ...
                        ['H',coordinates[6*dimensions:7*dimensions]]], basis='aug-cc-pvtz', charge=1, quantum_nuc = [0])
...
#        print('\n\n\n\n\n\n\n\n\n\nCONSTRAINED CALCULATION CONVERGED')
        ...
        mp2 = cNEOMP2(reg, con, energy_con)
...
# Test Optimization with Broyden-Fletcher-Goldfarb-Shanno Method:
    optimal_coordinates = scipy.optimize.minimize(energy, coordinates_inp, method='BFGS', jac=None, tol=1e-6, callback=None, options={'gtol': 1e-06, 'norm': inf, 'eps': 1e-06, 'maxiter': None, 'disp': True, 'return_all': False, 'finite_diff_rel_step': None})
    print(optimal_coordinates)

# Test Optimization with Nelder-Mead Method:
    #optimal_coordinates = scipy.optimize.minimize(energy, coordinates_inp, method='Nelder-Mead', bounds=None, tol=1e-6, callback=None, options={'disp': True, 'xatol': 0.000001, 'fatol': 0.000001})
    #print(optimal_coordinates)


#    # Test Single Point
#    print(energy(coordinates_inp))
