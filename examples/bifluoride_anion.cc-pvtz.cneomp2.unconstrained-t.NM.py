...
import inspect
print(sys.version)
#sys.stdout = open('bifluoride_anion.cc-pvtz.cneomp2.unconstrained-t.NM.log', 'wt')
...
#---------------------------------------------------------------------------------------------------------------
    ...
    coordinate_array[0,0] = 0.0 
    coordinate_array[0,1] = 0.0
    coordinate_array[0,2] = 0.0
    coordinate_array[1,0] = 0.0
    coordinate_array[1,1] = 0.0
    coordinate_array[1,2] = 1.1335
    coordinate_array[2,0] = 0.0
    coordinate_array[2,1] = 0.0
    coordinate_array[2,2] = -1.1335
...
#        print('\n\n\n\n\n\n\n\n\n\nCONSTRAINED CALCULATION CONVERGED')
        ...
        print('outputline', con.converged, distance1, distance2, totale)
        print('------------------------')
        print(R)
        print('------------------------')
